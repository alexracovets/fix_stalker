...
const variants = cva('', {
  variants: {
    variant: {
      ...
      destructive_label: cn('text-[1.8rem] font-roboto text-main-destructive-label'),
      h1: cn('text-[32px] font-roboto_condensed font-medium text-main-destructive-bg'),
...
export const AtomText = ({
  ...
  return (
    <Comp data-slot="text" className={cn(variants({ variant, className }))} {...props}>
      {children}
    </Comp>
  )
}
